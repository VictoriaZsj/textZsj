...
var Main = (function (_super) {
    ...
    Main.prototype.onResourceProgress = function (event) {
        ...
        var progress = event.itemsLoaded / event.itemsTotal;
     ...
     * 加载完成回调
     */
    Main.prototype.loadConfigComplete = function () {
        SceneManager.switcScene(SceneType.Login); //unlocal 
    };
    return Main;
}(eui.UILayer));
