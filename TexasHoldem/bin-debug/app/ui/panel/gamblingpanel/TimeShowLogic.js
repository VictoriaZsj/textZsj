...
var TimeShowLogic = (function () {
    function TimeShowLogic(label) {
        ...
        this.timeLabel.text = StringConstant.empty;
    }
    ...
    TimeShowLogic.prototype.onEnable = function () {
        Tick.AddSecondsInvoke(this.refreshTime, this);
    };
    TimeShowLogic.prototype.onDisable = function () {
        Tick.RemoveSecondsInvoke(this.refreshTime, this);
    };
    TimeShowLogic.prototype.refreshTime = function () {
        if (this.nowTotal != undefined) {
            ...
            if (this._offsetTime >= 0) {
                this.timeLabel.text = DateTimeUtil.formatCountdown(this._offsetTime);
        ...
        if (this.waitTime != undefined && this.waitTime != NaN) {
            ...
            if (this._offsetTime >= 0) {
                ...
                // let minStr: string = StringUtil.timeStringFormat(min);
                // let index: number = 0;
                // let img: eui.Image;
                ...
                // 	index++;
                // }
                // let secondsStr: string = StringUtil.timeStringFormat(seconds);
