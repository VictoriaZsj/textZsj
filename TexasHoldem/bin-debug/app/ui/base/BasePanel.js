...
var BasePanel = (function (_super) {
    ...
    function BasePanel() {
        ...
        _this.height = GameSetting.StageHeight;
        _this.grayMask = new eui.Image();
        _this.grayMask.source = ImageSource.GrayBg;
        _this.grayMask.scale9Grid = new egret.Rectangle(10, 9, 33, 15);
        _this.grayMask.top = 0;
        _this.grayMask.bottom = 0;
        _this.grayMask.left = 0;
        _this.grayMask.right = 0;
        _this.setGrayMask(true);
        return _this;
    ...
    BasePanel.prototype.onDisable = function (event) {
        this.removeEventListener(eui.UIEvent.COMPLETE, this.onAwake, this); //todo
        ...
        if (this.grayMask.hasEventListener(egret.TouchEvent.TOUCH_TAP)) {
    ...
    BasePanel.prototype.onTween = function () {
        if (this.tweenGroup) {
            if (this.grayMask && this.grayMask.visible) {
    ...
    BasePanel.prototype.onCloseTweenChange = function () {
        if (this.grayMask && this.grayMask.visible && this.tweenGroup.alpha < this._maskAlpha) {
