...
class LoginManager
{
	 ...
	 * 登录完成
	 */
	public static OnComplete: DelegateDispatcher = new DelegateDispatcher();
	/**
	 * 登录错误
	 */
	public static OnError: DelegateDispatcher = new DelegateDispatcher();
	/**
	 * 406错误，验证token失败
	 */
	public static OnValiateFail: DelegateDispatcher = new DelegateDispatcher();
}