...
class UISkinName
{
	 ...
	 * 获得道具面板
	 */
	public static GetItemTipsPanel = "resource/assets/skins/panel/GetItemTipsSkin.exml";
	/**
	 * 确定提示框
	 */
	...
	*/
	 ...
	 * 保险箱面板
	*/
	public static SafeBoxPanel = "resource/assets/skins/panel/SafeBoxPanel.exml";
	/**
	 * 好友面板
	*/
	 ...
	 * 我的奖品面板
	 */
	public static PrizePanel = "resource/assets/skins/panel/PrizePanel.exml";
	/**
	 * 锦标赛面板
	*/
...
class UIRendererSkinName
{
	...
	*/
	 ...
	 * 获得道具渲染项
	 */
	public static GetItemRenderer = "resource/assets/skins/renderer/GetItemRenderer.exml";
}
...
class ParticleSource
{
	 ...
	 * 获得金币图片
	 */
	public static GetCoin_Img = "getCoin_png";
	/**
	 * 获得金币配置
	 */
