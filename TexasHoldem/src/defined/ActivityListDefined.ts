...
{
    private static readonly activityConfig: string = "activity_list";
    ...
    public static GetInstance(): ActivityListDefined
    {
        ...
        if (DefinedManager.IsParsed(ActivityListDefined.activityConfig) == false)
        {
    ...
    public initialize()
    {
        let obj: Object = DefinedManager.GetData(ActivityListDefined.activityConfig);
