...
class SystemTimeManager
{
     ...
     * 某个时间点是否满足条件
    */
    public static IsInTime(id: number, startOffsetTime: number = 0, isGetDate: boolean = false): boolean | Date
    {
        if (id == 0)
        {
            return true;
    ...
    private static IsSystemTimeDefInTime(def: SystemTimeSpanDefinition, startOffsetTime: number = 0, isGetDate: boolean = false): boolean | Date
    {
