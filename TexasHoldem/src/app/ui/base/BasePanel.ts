...
abstract class BasePanel extends eui.Component
{
	 ...
	 * 是否关闭按钮缓动打开
	 */
	protected isCloseButtonTween: boolean = true;
	/*缓动*/
	 ...
	 * 遮罩点击是否关闭
	 */
	protected _isMaskClickClose: boolean = false;
	/**
	 * 遮罩alpha值
	 */
	...
	public constructor()
	{
		...
		this.grayMask.source = ImageSource.GrayBg;
		this.grayMask.scale9Grid = new egret.Rectangle(10, 9, 33, 15);
		this.grayMask.top = 0;
