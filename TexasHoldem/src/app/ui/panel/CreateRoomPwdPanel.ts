    ...
    */
    private setAnte(id: number)
    {
        if (id)
        {
            ...
            if (info)
            {
                this.ante1ToggleSwitch.label = info.ante[0].toString();
                this.ante2ToggleSwitch.label = info.ante[1].toString();
                this.ante3ToggleSwitch.label = info.ante[2].toString();
                this.ante4ToggleSwitch.label = info.ante[3].toString();
            }
            this.ante = 0;
    ...
    */
    private reset()
    {
        if (PlayingFieldManager.maxCarryList)
        {
            ...
            this.ante1ToggleSwitch.label = PlayingFieldManager.maxCarryList[0].ante[0].toString();
            this.ante2ToggleSwitch.label = PlayingFieldManager.maxCarryList[0].ante[1].toString();
            this.ante3ToggleSwitch.label = PlayingFieldManager.maxCarryList[0].ante[2].toString();
            this.ante4ToggleSwitch.label = PlayingFieldManager.maxCarryList[0].ante[3].toString();
        }
        if (this.selectedAnte)
        {
            this.selectedAnte.selected = false;
    ...
    private onClickHandler(event: egret.TouchEvent)
    {
        ...
        switch (event.target)
        {
            case this.ante1ToggleSwitch:
                this.ante = this.changeToNum(this.ante1ToggleSwitch.label);
                this.changSelectAnte(this.ante1ToggleSwitch);
                break;
            case this.ante2ToggleSwitch:
                this.ante = this.changeToNum(this.ante2ToggleSwitch.label);
                this.changSelectAnte(this.ante2ToggleSwitch);
                break;
            case this.ante3ToggleSwitch:
                this.ante = this.changeToNum(this.ante3ToggleSwitch.label);
                this.changSelectAnte(this.ante3ToggleSwitch);
                break;
            case this.ante4ToggleSwitch:
                this.ante = this.changeToNum(this.ante4ToggleSwitch.label);
