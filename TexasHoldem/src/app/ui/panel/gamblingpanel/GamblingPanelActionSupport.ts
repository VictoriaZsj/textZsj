...
class GamblingPanelActionSupport extends BaseGamblingPanelSupport
{
	...
	*/
	...
	private _panelShowStateList: Dictionary<string, boolean>;
	private _excludePanel: Array<string> = [UIModuleName.GamblingPanel, UIModuleName.MarqueePanel];
	...
	private playerStateChangeHandler(obj: any)
	{
		if (obj.roleId == UserManager.userInfo.roleId)
		{
			...
			{
				this._panelShowStateList = new Dictionary<string, boolean>();
			}
