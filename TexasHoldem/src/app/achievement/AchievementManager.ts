...
class AchievementManager
{
    ...
    * 成就解锁事件
    */
    public static achieveChangeEvent: DelegateDispatcher = new DelegateDispatcher();
    /**
     * 领取成就奖励事件
     */
    public static getAchievementPrizeEvent: DelegateDispatcher = new DelegateDispatcher();
    /**
     * 总成就和任务列表
     */
     ...
     * 设置某用户的成就信息
     */
    public static setAllAchieveList(info: UserInfo, result: SpRpcResult)
    {
