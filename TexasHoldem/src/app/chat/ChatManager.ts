...
class ChatManager
{
	...
	*/
	...
	// 聊天消息推送
	//-------------------------------------------------------
	public static pushChatMessageEa: DelegateDispatcher = new DelegateDispatcher();
	/**
	 * 发送聊天消息成功后广播
	*/
	public static onSendChatMsgEvent: DelegateDispatcher = new DelegateDispatcher();
	public static dispatchChatEvent()
	{
		ChatManager.pushChatMessageEa.dispatch();
	}
	private static OnMessageSend: DelegateDispatcher = new DelegateDispatcher();
